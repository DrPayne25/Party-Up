...
const SignUp = () => {
    ...
    const submit = async () => {
        ...
        await axios.post('http://34.208.228.216:8000/party_up_api/profile', formValues)
            .then((res => {
                // let data = res.data;
            }))
    ...
    const checkDuplicateEmail = () => {
        ...
        try {
            ...
            // change this to our deployed db later, make sure it is an .env variable  
            axios.get('http://34.208.228.216:8000/party_up_api/profile/?email=' + formValues.email)
                .then(res => {
